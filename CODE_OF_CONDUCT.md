...
As contributors and maintainers of the Fluffici Website, and in the interest of fostering an open and welcoming community, 
...
* Miss leading the guidelines of the project
* Publishing the source without explicit authorization from the staff of Fluffici
* Changing or editing the license file
* Make this repository public and using the code for other project
