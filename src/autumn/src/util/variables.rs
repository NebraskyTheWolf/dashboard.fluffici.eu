...
lazy_static! {
    ...
    pub static ref GIT_COMMIT: String =
        env::var("GIT_COMMIT").unwrap_or_else(|_| String::from("No revision."));
    ...
    pub static ref MONGO_DATABASE: String =
        env::var("AUTUMN_MONGO_DATABASE").unwrap_or_else(|_| "database".to_string());
